...
public class PhantomLockpicks : Relic
{
    ...
    {
        relicDesription = "Gain ability: 1 <sprite name=Ability> for 2 <sprite name=Lockpick>(Max " + Variables.relicIncreaseableNumberColor + Variables.phantomLockpicksMaxTimes + "x</color>)";
